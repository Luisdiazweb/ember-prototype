    ...
    get computedMessages(){
        ...
        for (let index = 0; index < messages.length; index++) {
            ...
            if(!nextElement || element.from != nextElement.from){
                ...
                element.avatar = element.mine? this.userService.user.avatar : this.args.chat.image;
                element.contactName = element.mine? this.userService.user.name : this.args.chat.name;
            }
        }
